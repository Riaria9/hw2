...
mydatastore.o: mydatastore.cpp mydatastore.h product.h clothing.h movie.h book.h util.h
	$(CXX) $(CXXFLAGS) $(DEFS) -o $@ -c mydatastore.cpp
	

amazon.o: amazon.cpp db_parser.h datastore.h product_parser.h book.h movie.h clothing.h mydatastore.h
